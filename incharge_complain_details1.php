...
<head>
    ...
    $i_id=$_SESSION['email'];
    $q2=$conn->query("SELECT location FROM police_station where i_id='$i_id'");
    // $q2=mysqli_fetch_assoc($result1);
    $location= $q2->fetch_assoc()['location'];
    ...
    $res2=$conn->query("select d_o_u,case_update from update_case where c_id='$cid'");
    ?>
