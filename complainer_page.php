		 ...
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<div class="top-w3-agile" style="color: gray">Type of Crime
					...
					<br>
						<!-- <input style="background-color: #313131;color: white" hidden id="latitude" type="date" name="latitude" value="">
            <input style="background-color: #313131;color: white" hidden id="longitude" type="date" name="longitude" value=""> -->
					<div class="top-w3-agile" style="color: gray">
					Description
